  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: MyAppBar(title: "Sauvegardes", canPop: true, canSendData: false),
        body: SizedBox(
                        ...
                        child: Card(
                          ...
                          child: ListTile(
                            ...
                            leading: Padding(
                              ...
                              child: Icon(_matchesData[index].sport == "Type de sport" ? MdiIcons.fileQuestionOutline : MdiIcons.fromString(_matchesData[index].sport), color: Controller.tealColor,),
                            ),
                            title: Row(
